...
```typescript
// From packages/core/src/treekey.ts
...
**Canonical Sources:**
- `packages/core/src/Streamable.ts` - **PRIMARY**: All byte-exact Java-compatible serialization primitives
- `packages/core/src/minimaWireSerializer.ts` - High-level hex bundle serializers (imports primitives from Streamable.ts)
- `packages/core/src/javaStreamables.ts` - Seed derivation and hashing utilities
- `packages/core/src/mmr.ts` - MMR tree operations
...
**Source:** `packages/core/src/bip39.ts`
...
**Source:** `packages/core/src/treekey.ts`
...
**Source:** `packages/core/src/wots.ts`
...
```typescript
// From packages/core/src/wots.ts
...
**Source:** `packages/core/src/mmr.ts`
...
**Source:** `packages/core/src/minima32.ts`
...
| `packages/core/src/bip39.ts` | Minima-compatible BIP39 seed derivation |
| `packages/core/src/treekey.ts` | Per-address TreeKey and TreeKeyNode implementation |
| `packages/core/src/wots.ts` | WOTS signature scheme (w=8, L=34, BouncyCastle compatible) |
| `packages/core/src/mmr.ts` | MMR tree construction and proofs |
| `packages/core/src/javaStreamables.ts` | Minima wire format serialization, per-address seed derivation |
| `packages/core/src/Streamable.ts` | Byte-exact Java-compatible serialization primitives |
| `packages/core/src/script.ts` | KISSVM script generation |
| `packages/core/src/derive.ts` | Script to address conversion |
| `packages/core/src/minima32.ts` | Mx Base32 encoding/decoding |
