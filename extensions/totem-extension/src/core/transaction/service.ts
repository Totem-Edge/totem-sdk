...
export class TransactionService {
  ...
  static async signWithPerAddressTreeKey(
    ...
    // Import utilities
    const { fromHex, setWotsLogger, disableWotsLogger, serializeTreeSignature, setTreeKeyLogger, disableTreeKeyLogger, serializeMMRProof } = await import('@totemsdk/core');
