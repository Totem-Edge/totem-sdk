...
describe('TreeKey Signing Chain Parity', () => {
  ...
  beforeAll(async () => {
    const treeKeyModule = await import('../../../../../../packages/core/src/treekey');
    ...
    const streamableModule = await import('../../../../../../packages/core/src/Streamable');
    serializeSignature = streamableModule.writeSignature;
    
    const mmrModule = await import('../../../../../../packages/core/src/mmr');
