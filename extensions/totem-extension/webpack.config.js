...
const sharedConfig = {
  ...
  optimization: {
    ...
    minimize: true,
    usedExports: true,
    concatenateModules: false  // Disable concatenation to avoid WASM module issues
  }
};
  ...
  plugins: [
    ...
    new CopyWebpackPlugin({
      patterns: [
        ...
        // SECURITY: demo.html is a dev/test page with inline event handlers
        // and test wallet addresses. Deliberately excluded from production.
        ...
        { from: 'src/approval/tx-approval.js', to: 'approval/tx-approval.js' },
        { from: 'src/approval/permissions.html', to: 'approval/permissions.html' },
        { from: 'src/approval/permissions-approval.js', to: 'approval/permissions-approval.js' },
