...
**Full guide:** [`docs/developers/sdk/edge-android-quickstart`](https://github.com/Totem-Edge/totem-sdk/blob/main/packages/docs-site/docs/developers/sdk/edge-android-quickstart.md)
