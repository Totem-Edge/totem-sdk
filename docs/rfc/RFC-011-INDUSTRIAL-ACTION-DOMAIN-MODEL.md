...
**Status:** Draft — Phase A (units & resources), Phase B (interlocks/safe-state + resource locks), Phase C (device error taxonomy), and Phase D (recipes/sagas composition) landed. Phases E–H outstanding.
**Created:** 2026-09-23
