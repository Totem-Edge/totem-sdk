 ...
 */
export declare function serializeMiniNumber(n: number): Uint8Array;
/**
 ...
 */
export declare function serializeMiniData(data: Uint8Array): Uint8Array;
/**
 ...
 */
export declare function hashAllObjects(...items: Uint8Array[]): Uint8Array;
/**
 ...
 */
export declare function deriveChainSeedJava(privateSeed: Uint8Array, index: number): Uint8Array;
/**
 ...
 */
export declare function deriveChildTreeSeedJava(childSeed: Uint8Array, childIndex: number): Uint8Array;
/**
 ...
 * @returns 32-byte SHA3-256 hash
 */
export declare function hashObject(data: Uint8Array): Uint8Array;
/**
 ...
 */
export declare function indexToMiniDataBytes(index: number): Uint8Array;
/**
 ...
 */
export declare function derivePerAddressSeed(baseSeed: Uint8Array, addressIndex: number): Uint8Array;
/**
 * Serialize MiniNumber.ZERO - cached for performance
 * Returns: [0x00, 0x01, 0x00] = scale(0) + length(1) + value(0)
 */
export declare function serializeMiniNumberZERO(): Uint8Array;
/**
 * Serialize MiniNumber.ONE
 * Returns: [0x00, 0x01, 0x01] = scale(0) + length(1) + value(1)
 */
export declare function serializeMiniNumberONE(): Uint8Array;
/**
 ...
 */
export declare function writeHashToStream(data: Uint8Array): Uint8Array;
/**
 ...
 * @returns 32-byte SHA3-256 hash
 */
export declare function javaHashAllObjects(...items: Uint8Array[]): Uint8Array;
/**
 ...
 */
export declare function createMMREntryNumber(value: bigint): MMREntryNumber;
/**
 ...
 */
export declare function serializeMMREntryNumber(entry: MMREntryNumber): Uint8Array;
/**
 ...
 */
export declare function serializeMMRData(mmrData: MMRData): Uint8Array;
/**
 ...
 */
export declare function serializeMMREntry(entry: MMREntry): Uint8Array;
/**
 ...
 */
export declare function deriveRootPrivSeed(baseSeed: Uint8Array): Uint8Array;
/**
 ...
 */
export declare function deriveUnifiedChildSeed(baseSeed: Uint8Array, index: number): Uint8Array;
/**
 ...
 */
export declare function precomputeTransactionCoinID(inputs: {
    coinId: Uint8Array;
}[], outputs: {
    coinId: Uint8Array;
}[]): void;
