...
export type ASTNode =
  | ReturnNode | AssertNode | LetNode | StoreStateNode | StoreTupleNode
  | IfNode | WhileNode | ForNode | ForeachNode | SwitchNode
  | FuncDefNode | CallStmtNode | ExecNode
...
export interface StoreTupleNode { type: 'STORE_TUPLE'; index: ASTNode; value: ASTNode; span?: Span }
export interface IfNode         { type: 'IF';          cond: ASTNode; then: ASTNode[]; elseifBranches?: { cond: ASTNode; body: ASTNode[] }[]; else?: ASTNode[]; span?: Span }
export interface WhileNode      { type: 'WHILE';       cond: ASTNode; body: ASTNode[]; span?: Span }
...
export interface ExecNode       { type: 'EXEC';        script: ASTNode; span?: Span }
...
export interface ChecksigNode   { type: 'CHECKSIG';    args: ASTNode[]; span?: Span }
