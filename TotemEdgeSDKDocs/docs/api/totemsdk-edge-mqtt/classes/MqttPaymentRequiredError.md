...
[@totemsdk/edge-mqtt](../index.md) / MqttPaymentRequiredError

# Class: MqttPaymentRequiredError
...
> **new MqttPaymentRequiredError**(`message?`): `MqttPaymentRequiredError`

#### Parameters

##### message?

`string` = `'Payment required to process this message'`
