...
[@totemsdk/edge-mqtt](../index.md) / MqttCreditExceededError

# Class: MqttCreditExceededError
...
> **new MqttCreditExceededError**(`message?`): `MqttCreditExceededError`

#### Parameters

##### message?

`string` = `'Unpaid credit limit exceeded'`
